...
WARNING: In this lab we are forcing to use the 18.0.0 version of RHOSO so that we can exercise to update the environment to the latest version available. 
