...
[source,bash,role=execute]
----
subscription-manager register --org="6340056"  --activationkey="train_the_trainers" 
#subscription-manager register --username pnavarro@redhat.com --password "1amuntvalencian0"
...
From your workstation, copy the manifest.zip to the hypevisor host {bastion_public_hostname}:
[source,bash,role=execute]
----
